	  	  ...
	  	  <form> 
				...
				<h3>PERSONAL INFORMATION</h3>
				 <div class="nameInput">
					 ...
					 <input id="nameInput" type="text"  value="${o.receiver}" placeholder="请输入收件人名称" > 
				 </div>
				 <div class="phoneInput">
					 <span>电话号码<label>*</label>
					 <label class="errorMessage text-danger"></label>
					 </span>
					 <input id="phoneInput" type="text" value="${o.mobile}" > 
				 </div>
				 ...
				 <div class="detailAddressInput">
					 ...
					 <input id="detailAddressInput" type="text"  value="${o.address}"> 
				 </div>
				   <div class="postCodeInput">
					 <span>邮政编码<label>*</label>
					 <label class="errorMessage text-danger"></label>
					 </span>
					 <input  id="postCodeInput" type="text"  value="${o.post}"> 
				 </div>
...
$(function(){
    ...
    $("input#registerButtonTD").click(function(){
        ...
        if(isRight==true){
        	$.post(
        	 "foreUpdateOrderAddress",
        	 {"orderId":oid,"receiver":$("#nameInput").val(),"mobile":$("#phoneInput").val(),
        	"post":$("#postCodeInput").val(),
        	"address":simpleArea+" "+$("#detailAddressInput").val()},
        	 function(result){
        		 if(result=="success")
        			 location.href="foreListOrderDetail?oid="+oid;
        		 else
