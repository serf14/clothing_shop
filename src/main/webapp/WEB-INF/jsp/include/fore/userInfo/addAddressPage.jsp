...
<div class="pag-nav">
		...
		<div class="register">
	  	  <form> 
				...
				<h3>PERSONAL INFORMATION</h3>
				 <div class="nameInput">
					 ...
					 <input id="nameInput" type="text"   placeholder="请输入收件人名称" > 
				 </div>
				 ...
				 <div class="detailAddressInput">
					 ...
					 <input id="detailAddressInput" type="text"  value=""> 
				 </div>
				   <div class="postCodeInput">
					 <span>邮政编码<label>*</label>
					 <label class="errorMessage text-danger"></label>
					 </span>
					 <input  id="postCodeInput" type="text"  value=""> 
				 </div>
			...
			<div class="register-but">
				   <input id="registerButtonTD" type="submit" value="创建">
				   <div class="clearfix"> </div>
			</div>
	   </div>
...
$(function(){
    ...
    $("#registerButtonTD").click(function(){
        ...
        if(isRight==true){
        	$.post(
        	 "foreCreateAddress",
        	 {"name":$("#nameInput").val(),"phone":$("#phoneInput").val(),
        	...
        	"detailedArea":$("#detailAddressInput").val() },
        	 function(result){
        		 if(result=="success")
        			 ...
        			 $(".nameInput label.errorMessage").html("添加地址失败"); 
        	 }
        	);
        }
